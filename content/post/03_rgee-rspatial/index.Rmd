...
### Mapping the present temperature 

For this example, we use the ERA5-Land dataset,  a reanalysis dataset providing a consistent view of the evolution of
land variables over several decades at an enhanced resolution compared to ERA5.

More information [click here](https://developers.google.com/earth-engine/datasets/catalog/ECMWF_ERA5_LAND_MONTHLY)
...
Map$addLayer(
  ...
  visParams = list(
    min = 5,
    max = 25,
    palette = cpt(pal = "gmt_GMT_seis",n = 10))
  )

# Define box to study area 
...
# Indentifying min and max value of temperature
...
# Generate a thumbnail image in a RasterLayer o stars format  
...
# 2. Cooking data for mapping with tmap --------------------------------------------------
...
# Elaboration of the Temperature Map
temp_map <- map %>% 
